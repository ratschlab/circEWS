...
class FeaturesWithMissingVals:
    ...
    def transform(self, df_pat, df_label_pat, pid=None):
        ...
        for idx,ts in np.ndenumerate(ts_col):
            ...
            summary_cont_pharma_high_0=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_high_0)
            ...
            summary_cont_pharma_high_1=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_high_1)
            ...
            summary_cont_pharma_high_2=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_high_2)
            ...
            summary_cont_pharma_high_3=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_high_3)
            df_cont_pharma_high_entire=np.array(df_pat.iloc[0:row_idx][cont_pharma_freq_hi_cols])
            summary_cont_pharma_high_entire=np.nanmean(df_cont_pharma_high_entire,axis=0)
            ...
            summary_cont_pharma_med_0=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_med_0)
            ...
            summary_cont_pharma_med_1=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_med_1)
            ...
            summary_cont_pharma_med_2=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_med_2)
            ...
            summary_cont_pharma_med_3=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_med_3)
            df_cont_pharma_med_entire=np.array(df_pat.iloc[0:row_idx][cont_pharma_freq_med_cols])
            summary_cont_pharma_med_entire=np.nanmean(df_cont_pharma_med_entire,axis=0)
            ...
            summary_cont_pharma_low_0=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_low_0)
            ...
            summary_cont_pharma_low_1=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_low_1)
            ...
            summary_cont_pharma_low_2=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_low_2)
            ...
            summary_cont_pharma_low_3=mlhc_array.time_window_5point_summary_non_robust_NAN(df_cont_pharma_low_3)
            df_cont_pharma_low_entire=np.array(df_pat.iloc[0:row_idx][cont_pharma_freq_low_cols])
            summary_cont_pharma_low_entire=np.nanmean(df_cont_pharma_low_entire,axis=0)
            ...
            cont_summary_high_0=mlhc_array.time_window_5point_summary_NAN(df_cont_high_0)
            ...
            cont_summary_high_1=mlhc_array.time_window_5point_summary_NAN(df_cont_high_1)
            ...
            cont_summary_high_2=mlhc_array.time_window_5point_summary_NAN(df_cont_high_2)
            ...
            cont_summary_high_3=mlhc_array.time_window_5point_summary_NAN(df_cont_high_3)
            ...
            cont_summary_med_0=mlhc_array.time_window_5point_summary_NAN(df_cont_med_0)
            ...
            cont_summary_med_1=mlhc_array.time_window_5point_summary_NAN(df_cont_med_1)
            ...
            cont_summary_med_2=mlhc_array.time_window_5point_summary_NAN(df_cont_med_2)
            ...
            cont_summary_med_3=mlhc_array.time_window_5point_summary_NAN(df_cont_med_3)
            ...
            cont_summary_low_0=mlhc_array.time_window_5point_summary_NAN(df_cont_low_0)
            ...
            cont_summary_low_1=mlhc_array.time_window_5point_summary_NAN(df_cont_low_1)
            ...
            cont_summary_low_2=mlhc_array.time_window_5point_summary_NAN(df_cont_low_2)
            ...
            cont_summary_low_3=mlhc_array.time_window_5point_summary_NAN(df_cont_low_3)
            ...
            if self.dim_reduced_data:
                ...
                lac_feat_all=np.nansum((alac_all>=2) | (vlac_all>=2))/alac_all.size
                lac_feat_med_0=np.nansum((alac_med_0>=2) | (vlac_med_0>=2))/alac_med_0.size
                lac_feat_med_1=np.nansum((alac_med_1>=2) | (vlac_med_1>=2))/alac_med_1.size
                lac_feat_med_2=np.nansum((alac_med_2>=2) | (vlac_med_2>=2))/alac_med_2.size
                lac_feat_med_3=np.nansum((alac_med_3>=2) | (vlac_med_3>=2))/alac_med_3.size
                ...
                # Event 1
                event1_occs=np.nansum( ((vlac_all>=2) | (alac_all>=2)) & ((map_all<=65) | (dop_all>0) | (mil_all>0) | (lev_all>0) | (theo_all>0)) )

                event1_feat_all=  np.nansum( ((vlac_all>=2)   | (alac_all>=2))   & ((map_all<=65)   | (dop_all>0)   | (mil_all>0)   | (lev_all>0)   | (theo_all>0))   )/dop_all.size
                event1_feat_med_0=np.nansum( ((vlac_med_0>=2) | (alac_med_0>=2)) & ((map_med_0<=65) | (dop_med_0>0) | (mil_med_0>0) | (lev_med_0>0) | (theo_med_0>0)) )/dop_med_0.size
                event1_feat_med_1=np.nansum( ((vlac_med_1>=2) | (alac_med_1>=2)) & ((map_med_1<=65) | (dop_med_1>0) | (mil_med_1>0) | (lev_med_1>0) | (theo_med_1>0)) )/dop_med_1.size
                event1_feat_med_2=np.nansum( ((vlac_med_2>=2) | (alac_med_2>=2)) & ((map_med_2<=65) | (dop_med_2>0) | (mil_med_2>0) | (lev_med_2>0) | (theo_med_2>0)) )/dop_med_2.size
                event1_feat_med_3=np.nansum( ((vlac_med_3>=2) | (alac_med_3>=2)) & ((map_med_3<=65) | (dop_med_3>0) | (mil_med_3>0) | (lev_med_3>0) | (theo_med_3>0)) )/dop_med_3.size
                ...
                noreph_feat_all=np.nansum((noreph_all>0) & (noreph_all<0.1))/noreph_all.size
                noreph_feat_med_0=np.nansum((noreph_med_0>0) & (noreph_med_0<0.1))/noreph_med_0.size
                noreph_feat_med_1=np.nansum((noreph_med_1>0) & (noreph_med_1<0.1))/noreph_med_1.size
                noreph_feat_med_2=np.nansum((noreph_med_2>0) & (noreph_med_2<0.1))/noreph_med_2.size
                noreph_feat_med_3=np.nansum((noreph_med_3>0) & (noreph_med_3<0.1))/noreph_med_3.size
                ...
                epineph_feat_all=np.nansum((epineph_all>0) & (epineph_all<0.1))/epineph_all.size
                epineph_feat_med_0=np.nansum((epineph_med_0>0) & (epineph_med_0<0.1))/epineph_med_0.size
                epineph_feat_med_1=np.nansum((epineph_med_1>0) & (epineph_med_1<0.1))/epineph_med_1.size
                epineph_feat_med_2=np.nansum((epineph_med_2>0) & (epineph_med_2<0.1))/epineph_med_2.size
                epineph_feat_med_3=np.nansum((epineph_med_3>0) & (epineph_med_3<0.1))/epineph_med_3.size

                epineph_feat2_all=np.nansum(epineph_all>=0.1)/epineph_all.size
                epineph_feat2_med_0=np.nansum(epineph_med_0>=0.1)/epineph_med_0.size
                epineph_feat2_med_1=np.nansum(epineph_med_1>=0.1)/epineph_med_1.size
                epineph_feat2_med_2=np.nansum(epineph_med_2>=0.1)/epineph_med_2.size
                epineph_feat2_med_3=np.nansum(epineph_med_3>=0.1)/epineph_med_3.size
                ...
                # Event 2
                event2_occs=np.nansum( ((alac_all>=2) | (vlac_all>=2)) & ((noreph_all>0) & (noreph_all<0.1) | (epineph_all>0) & (epineph_all<0.1)) )

                event2_feat_all=np.nansum(  ((alac_all>=2) | (vlac_all>=2)) & ((noreph_all>0) & (noreph_all<0.1) | (epineph_all>0) & (epineph_all<0.1)) )/noreph_all.size
                event2_feat_med_0=np.nansum( ((alac_med_0>=2) | (vlac_med_0>=2)) & ((noreph_med_0>0) & (noreph_med_0<0.1) | (epineph_med_0>0) & (epineph_med_0<0.1)) )/noreph_med_0.size
                event2_feat_med_1=np.nansum( ((alac_med_1>=2) | (vlac_med_1>=2)) & ((noreph_med_1>0) & (noreph_med_1<0.1) | (epineph_med_1>0) & (epineph_med_1<0.1)) )/noreph_med_1.size
                event2_feat_med_2=np.nansum( ((alac_med_2>=2) | (vlac_med_2>=2)) & ((noreph_med_2>0) & (noreph_med_2<0.1) | (epineph_med_2>0) & (epineph_med_2<0.1)) )/noreph_med_2.size
                event2_feat_med_3=np.nansum( ((alac_med_3>=2) | (vlac_med_3>=2)) & ((noreph_med_3>0) & (noreph_med_3<0.1) | (epineph_med_3>0) & (epineph_med_3<0.1)) )/noreph_med_3.size
                ...
                # Event 3
                event3_occs=np.nansum( ((alac_all>=2) | (vlac_all>=2)) & ((noreph_all>=0.1) | (epineph_all>=0.1) | (vaso_all>0)) )

                event3_feat_all=np.nansum( ((alac_all>=2) | (vlac_all>=2)) & ((noreph_all>=0.1) | (epineph_all>=0.1) | (vaso_all>0)) )/noreph_all.size
                event3_feat_med_0=np.nansum( ((alac_med_0>=2) | (vlac_med_0>=2)) & ((noreph_med_0>=0.1) | (epineph_med_0>=0.1) | (vaso_med_0>0)) )/noreph_med_0.size
                event3_feat_med_1=np.nansum( ((alac_med_1>=2) | (vlac_med_1>=2)) & ((noreph_med_1>=0.1) | (epineph_med_1>=0.1) | (vaso_med_1>0)) )/noreph_med_1.size
                event3_feat_med_2=np.nansum( ((alac_med_2>=2) | (vlac_med_2>=2)) & ((noreph_med_2>=0.1) | (epineph_med_2>=0.1) | (vaso_med_2>0)) )/noreph_med_2.size
                event3_feat_med_3=np.nansum( ((alac_med_3>=2) | (vlac_med_3>=2)) & ((noreph_med_3>=0.1) | (epineph_med_3>=0.1) | (vaso_med_3>0)) )/noreph_med_3.size
            ...
            if self.dim_reduced_data:
                ...
                event1_feat_cur=np.nansum( ((alac_cur>=2) | (vlac_cur>=2)) & ((map_cur<=65) | (dop_cur>0) | (mil_cur>0) | (lev_cur>0) | (theo_cur>0)) )
                ...
                event2_feat_cur=np.nansum( ((alac_cur>=2) | (vlac_cur>=2)) & ((noreph_cur>0) & (noreph_cur<0.1) | (epineph_cur>0) & (epineph_cur<0.1)) )
                vaso_cur=np.array(df_pat.iloc[row_idx]["pm45"])
                vaso_feat_cur=np.nansum(vaso_cur>0)
                event3_feat_cur=np.nansum( ((alac_cur>=2) | (vlac_cur>=2)) & ((noreph_cur>=0.1) | (epineph_cur>=0.1) | (vaso_cur>0)) )
